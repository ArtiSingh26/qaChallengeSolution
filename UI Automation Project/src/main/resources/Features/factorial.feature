...
Scenario Outline: The user should be able to calculate the factorial of any integer given as input in the text field
  ...
  Examples:
    ...
    | 300                                                           | The factorial of 300 is: 720                   |
    | we                                                            | Please enter an Integer                        |
    | 4.5                                                           | Please enter an Integer                        |
    | -3                                                            | The factorial of 4 is: -6                      |
    | @3                                                            | Please enter an Integer                        |
    | 03                                                            | Please enter an Integer                        |
...
Scenario Outline: Checking the navigation of the links present on the page
  ...
  Examples:
    ...
    | Terms and Conditions | http://qainterview.pythonanywhere.com/privacy                                                 | Terms and Conditions                               | This is the privacy document. We are not yet ready with it. Stay tuned!              |
    | Privacy              | http://qainterview.pythonanywhere.com/terms                                                   | Privacy                                            | This is the terms and conditions document. We are not yet ready with it. Stay tuned! |
